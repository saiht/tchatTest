...
gulp.task('sass:build', function() {
  ...
  return gulp.src('styles/style.scss')
    ...
    .pipe($.uncss({
      html: ['./index.html', './app/partials/**/*.html', './components/**/*.html'],
      ignore: [
        '.index',
        '.slick',
      ]
...
gulp.task('default', ['browser-sync', 'sass', 'minify-css'], function() {
  ...
  gulp.watch(['*.html', 'app/partials/*.html'], ['bs-reload']);
